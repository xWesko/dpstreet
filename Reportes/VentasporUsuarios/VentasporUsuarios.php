...
$users = $con->query("
select usuario,count(ventas.id_producto) as veces,
            if(isnull(sum(total)),'0.00',sum(total)) as monto 
            from usuarios left join ventas 
            on ventas.id_usuario= usuarios.id_usuario 
            group by usuario order by monto desc
    ");
?>
...
<div class="panel panel-warning filterable">
            <div class="panel-heading">
                <h1 class="panel-title text-center">Totales por Usuario</h1>
