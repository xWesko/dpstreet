...
$users = $con->query("select concat(cliente,' ',ap_cliente,' ',am_cliente) as clientewe,count(ventas.id_producto) as veces,
            if(isnull(sum(total)),'0.00',sum(total)) as monto 
            from clientes left join ventas 
            on ventas.id_cliente = clientes.id_cliente 
            group by clientewe order by monto desc");
?>
<div class="panel panel-warning filterable">
            <div class="panel-heading">
                <h1 class="panel-title text-center">Sales Per Costumer</h1>
...
<div class="panel panel-warning filterable">
            <div class="panel-heading">
                <h1 class="panel-title text-center">Totales por Clientes</h1>
